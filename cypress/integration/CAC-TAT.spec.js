...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche os campos obrigatórios e envia o formulário', function(){
        const longText = 'Teste texto longo, Teste texto longo, Teste texto longo, Teste texto longo, Teste texto longo, Teste texto longo, Teste texto longo, Teste texto longo, Teste texto longo,'
